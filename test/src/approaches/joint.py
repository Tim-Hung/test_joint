...
class Appr(object):
    ...
    def __init__(self,model,nepochs=100,sbatch=100,lr=0.05,lr_min=1e-4,lr_factor=1.2,lr_patience=5,clipgrad=10000,args=None):
        self.model=model
    ...
    def train(self,tasks,xtrain,ytrain,xvalid,yvalid):
        ...
        torch.save(self.model.state_dict(),'pretrain_joint_lr0.1_Multistep_clip_nomaxpool.pth')
    ...
    def eval_validation(self,t,x,y):
        ...
        for i in range(0,len(r),self.sbatch):
            ...
            #print(type(outputs))
            #print(outputs)
            output=outputs[0]#single mask #[t]
            #print(type(output))
            #print(output)
