...
class Net(torch.nn.Module):
    ...
    def __init__(self,inputsize,taskcla):
        ...
        #self.last=torch.nn.Linear(2048,2)# single mask:2 for cifar10
        ...
        self.bn1=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        #2-1
        self.bn2_1_1=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#=False)
        self.bn2_1_2=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        self.bn2_1_3=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn2_1_d=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        #self.bnt2_1=torch.nn.Embedding(len(self.taskcla),256)
        #2-2
        self.bn2_2_1=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        self.bn2_2_2=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        self.bn2_2_3=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        #2-3
        self.bn2_3_1=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        self.bn2_3_2=torch.nn.BatchNorm2d(64, affine=False, track_running_stats=True)#False)
        self.bn2_3_3=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        #3-1
        self.bn3_1_1=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_1_2=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_1_3=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn3_1_d=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        #self.ect3_1=torch.nn.Embedding(len(self.taskcla),512)
        #3-2
        self.bn3_2_1=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_2_2=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_2_3=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        #3-3
        self.bn3_3_1=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_3_2=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_3_3=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        #3-4
        self.bn3_4_1=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_4_2=torch.nn.BatchNorm2d(128, affine=False, track_running_stats=True)#False)
        self.bn3_4_3=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        #4-1
        self.bn4_1_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_1_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_1_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#=False)
        self.bn4_1_d=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #self.ect3_1=torch.nn.Embedding(len(self.taskcla),512)
        #4-2
        self.bn4_2_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_2_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_2_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #4-3
        self.bn4_3_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_3_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_3_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #4-4
        self.bn4_4_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_4_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_4_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #4-5
        self.bn4_5_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_5_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_5_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #4-6
        self.bn4_6_1=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_6_2=torch.nn.BatchNorm2d(256, affine=False, track_running_stats=True)#False)
        self.bn4_6_3=torch.nn.BatchNorm2d(1024, affine=False, track_running_stats=True)#False)
        #5-1
        self.bn5_1_1=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_1_2=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_1_3=torch.nn.BatchNorm2d(2048, affine=False, track_running_stats=True)#False)
        self.bn5_1_d=torch.nn.BatchNorm2d(2048, affine=False, track_running_stats=True)#False)
        #self.ect3_1=torch.nn.Embedding(len(self.taskcla),512)
        #5-2
        self.bn5_2_1=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_2_2=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_2_3=torch.nn.BatchNorm2d(2048, affine=False, track_running_stats=True)#False)
        #5-3
        self.bn5_3_1=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_3_2=torch.nn.BatchNorm2d(512, affine=False, track_running_stats=True)#False)
        self.bn5_3_3=torch.nn.BatchNorm2d(2048, affine=False, track_running_stats=True)#False)
